                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                    ...
                    <form onSubmit={addSubject} className="flex flex-col sm:flex-row gap-2">
                        ...
                        <div className="flex gap-2">
                            <input type="text" placeholder="새로운 과목..." className="px-5 py-2.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl text-sm focus:ring-2 focus:ring-indigo-500 outline-none w-full sm:w-48" value={newSubjectName} onChange={(e) => setNewSubjectName(e.target.value)} />
